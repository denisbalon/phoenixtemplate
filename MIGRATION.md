...
The `gogogo!` propose-and-confirm gate + on-branch per-node cadence (N≥1 atomic commits per branch) + per-project rules. This is the most-asked-for piece because it changes how AI sessions feel without touching the codebase.
