...
| Topic | Doc |
|---|---|
| First-time setup, credentials | [docs/setup.md](docs/setup.md) |
| Product spec (live deltas + frozen behavior) | [docs/spec.md](docs/spec.md) |
| Architecture, data flow, schema | [docs/architecture.md](docs/architecture.md) |
